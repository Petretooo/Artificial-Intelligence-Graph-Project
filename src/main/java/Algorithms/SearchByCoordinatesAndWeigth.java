...
public class SearchByCoordinatesAndWeigth {
    private Graph graph;
    ...
    public SearchByCoordinatesAndWeigth(Graph graph) {
        this.graph = graph;
    }
    ...
    private void addNode(Node childNode, List<Node> queue) {
        ...
        childNode.distanceToEnd = calculateDistance(childNode.x, childNode.y, childNode);
    ...
    private double calculateDistance(double x, double y, Node child) {
        //FT = D * 0.8 + T * 0.6
        ...
        double ft = (c*0.8) + (child.weight * 0.6);
